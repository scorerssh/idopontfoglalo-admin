                ...
                <div
                    ...
                    <div class="absolute bottom-12 left-4 max-w-[480px] text-white p-4">
                        ...
                        <p class="mt-6 text-sm leading-7 text-white/90 font-medium drop-shadow-md">
                            Egyszerű eszköz a foglalások gyors és átlátható kezeléséhez. </p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex w-full items-center justify-center bg-[#f5f5f3] px-10 md:px-20 lg:w-[55%] z-20">
                <div class="w-full max-w-[460px]">
                    ...
                    <div class="text-center mb-12 flex flex-col items-center">
                        ...
                        <p class="mt-4 text-[16px] text-black/55">Foglalások kezelése egyszerűen.
                        </p>
                    </div>
                    ...
                    <form class="space-y-5" @submit.prevent="submitLogin">
                        ...
                        <div>
                            <label class="mb-2.5 block text-[15px] font-medium text-black/90">Password</label>
                            <div class="relative">
                                <input v-model="form.password" :type="showPassword ? 'text' : 'password'"
                                    placeholder="Enter your password"
                                    class="h-14 w-full rounded-xl border border-black/5 bg-white px-5 outline-none focus:ring-1 focus:ring-black/10 transition-all" />
                                <button type="button" @click="showPassword = !showPassword"
                                    class="absolute right-5 top-1/2 -translate-y-1/2 opacity-30 hover:opacity-100 focus:outline-none">
                                    {{ showPassword ? '🔒' : '👁️' }}
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                <label for="remember"
                                    class="text-sm font-medium text-black/60 cursor-pointer">Emlékezzen
                                    rám</label>
                            </div>
                        ...
                        <div class="pt-4 space-y-4">
                            <button type="submit"
                                class="h-14 w-full rounded-xl bg-black font-semibold text-white hover:bg-black/90 transition-all active:scale-[0.98] shadow-lg">
                                Bejelentkezés
                            </button>
                        </div>
                    </form>
...
/* Lassú zoom effekt a háttérnek (opcionális) */
.scale-110 {
