...
<template>
    <Teleport to="body">
        <template v-if="showModal">
            ...
            <div
                class="modal bg-white p-6 rounded-lg shadow-lg fixed top-1/2 left-1/2 -translate-x-1/2  -translate-y-1/2 w-[calc(100%-20px)] h-[calc(100%-20px)] xl:w-1/3 lg:1/2 md:1/2 z-50 overflow-y-scroll">
